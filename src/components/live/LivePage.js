  ...
  return (
    <div className="live-page">
      ...
      <div className="alert alert-warning">
        ...
        <p>If, during playback, your volume is low, ensure that you have set your devices volume to full <strong>and</strong> you have set the SermonAudio player volume to full in the video controls. The two things are independent of each other.</p>
